...
```bash
git clone https://github.com/Sahil-Kashyap-in/Plagiarism-checker-Python
```
...
Explore it and twist it to your own use case, in case of any question feel free to reach me out directly *kashyap6sahil(at)gmail.com*
